                    ...
                    return(
                        <div key={item.name} className="screen col-xl-2 col-lg-3 col-md-4 col-10 m-3" >
                            <div className="screen-image">
                                <img src={`https://starwars-visualguide.com/assets/img/characters/${item.uid}.jpg`} onError={handleError}></img>
                            </div>
                            <div className="screen-overlay"></div>
                            <div className="screen-content">
                                <div className="options">
                                <div onClick={() => navigate(`/people/${item.uid}`)}><i className="details"><FontAwesomeIcon icon={faPlus} /></i></div>
